...
def combine_audio_with_pauses(audio_segments, speakers, pause_ms=DEFAULT_PAUSE_MS, same_speaker_pause_ms=SAME_SPEAKER_PAUSE_MS, target_dbfs=-20.0, fade_ms=5):
    ...
    for i, segment in enumerate(audio_segments):
        ...
        # Ensure channel consistency - convert all to mono
    ...
    # Simple concatenation - no crossfade which can cause artifacts
    ...
    for segment, speaker in zip(audio_segments[1:], speakers[1:]):
        ...
        # Simple concatenation with silence in between
